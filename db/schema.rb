...
ActiveRecord::Schema.define(version: 20_191_218_145_825) do
  ...
  create_table 'active_storage_attachments', force: :cascade do |t|
    ...
    t.index %w[record_id], name: 'index_active_storage_attachments_on_record_id'
  ...
  create_table 'attendances', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[meeting_id], name: 'index_attendances_on_meeting_id'
    t.index %w[user_id], name: 'index_attendances_on_user_id'
  end
  ...
  create_table 'box_items', force: :cascade do |t|
    ...
    t.index %w[box_id], name: 'index_box_items_on_box_id'
    t.index %w[created_by_id], name: 'index_box_items_on_created_by_id'
    t.index %w[inventory_type_id], name: 'index_box_items_on_inventory_type_id'
    t.index %w[researched_by_id], name: 'index_box_items_on_researched_by_id'
    t.index %w[updated_by_id], name: 'index_box_items_on_updated_by_id'
  end
  ...
  create_table 'box_request_abuse_types', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[abuse_type_id],
            name: 'index_box_request_abuse_types_on_abuse_type_id'
    t.index %w[box_request_id],
            name: 'index_box_request_abuse_types_on_box_request_id'
  end
  ...
  create_table 'box_requests', force: :cascade do |t|
    ...
    t.index %w[requester_id], name: 'index_box_requests_on_requester_id'
    t.index %w[reviewed_by_id], name: 'index_box_requests_on_reviewed_by_id'
  end
  ...
  create_table 'boxes', force: :cascade do |t|
    ...
    t.index %w[assembled_by_id], name: 'index_boxes_on_assembled_by_id'
    t.index %w[assembly_location_id],
            name: 'index_boxes_on_assembly_location_id'
    t.index %w[box_request_id], name: 'index_boxes_on_box_request_id'
    t.index %w[design_reviewed_by_id],
            name: 'index_boxes_on_design_reviewed_by_id'
    t.index %w[designed_by_id], name: 'index_boxes_on_designed_by_id'
    t.index %w[followed_up_by_id], name: 'index_boxes_on_followed_up_by_id'
    t.index %w[researched_by_id], name: 'index_boxes_on_researched_by_id'
    t.index %w[shipped_by_id], name: 'index_boxes_on_shipped_by_id'
    t.index %w[shipping_payment_id], name: 'index_boxes_on_shipping_payment_id'
  end
  ...
  create_table 'core_box_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[abuse_type_id], name: 'index_core_box_items_on_abuse_type_id'
    t.index %w[inventory_type_id],
            name: 'index_core_box_items_on_inventory_type_id'
  end
  ...
  create_table 'inventory_adjustments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[box_item_id], name: 'index_inventory_adjustments_on_box_item_id'
    t.index %w[inventory_tally_id],
            name: 'index_inventory_adjustments_on_inventory_tally_id'
    t.index %w[purchase_id], name: 'index_inventory_adjustments_on_purchase_id'
  end
  ...
  create_table 'inventory_tallies', force: :cascade do |t|
    ...
    t.index %w[inventory_type_id],
            name: 'index_inventory_tallies_on_inventory_type_id'
    t.index %w[storage_location_id],
            name: 'index_inventory_tallies_on_storage_location_id'
  end
  ...
  create_table 'meetings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[location_id], name: 'index_meetings_on_location_id'
    t.index %w[meeting_type_id], name: 'index_meetings_on_meeting_type_id'
  end
  ...
  create_table 'message_logs', force: :cascade do |t|
    ...
    t.index %w[messageable_type messageable_id],
            name: 'index_message_logs_on_messageable_type_and_messageable_id'
    t.index %w[sendable_type sendable_id],
            name: 'index_message_logs_on_sendable_type_and_sendable_id'
    t.index %w[sent_by_id], name: 'index_message_logs_on_sent_by_id'
  end
  ...
  create_table 'purchases', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[location_id], name: 'index_purchases_on_location_id'
    t.index %w[purchased_by_id], name: 'index_purchases_on_purchased_by_id'
    t.index %w[reimbursed_by_id], name: 'index_purchases_on_reimbursed_by_id'
  end
  ...
  create_table 'user_permissions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id], name: 'index_user_permissions_on_user_id'
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[invitation_token],
            name: 'index_users_on_invitation_token', unique: true
    ...
    t.index %w[volunteer_id], name: 'index_users_on_volunteer_id'
  end
  ...
  create_table 'volunteers', force: :cascade do |t|
    ...
    t.index %w[university_location_id],
            name: 'index_volunteers_on_university_location_id'
  end
  ...
  add_foreign_key 'inventory_tallies',
                  'locations',
