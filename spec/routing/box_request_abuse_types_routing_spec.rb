...
RSpec.describe BoxRequestAbuseTypesController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #edit' do
      expect(get: '/box_request_abuse_types/1/edit').to route_to(
        'box_request_abuse_types#edit',
        id: '1'
      )
    end
    ...
    it 'routes to #update via PUT' do
      expect(put: '/box_request_abuse_types/1').to route_to(
        'box_request_abuse_types#update',
        id: '1'
      )
    end

    it 'routes to #update via PATCH' do
      expect(patch: '/box_request_abuse_types/1').to route_to(
        'box_request_abuse_types#update',
        id: '1'
      )
    end
    ...
    it 'routes to #destroy' do
      expect(delete: '/box_request_abuse_types/1').to route_to(
        'box_request_abuse_types#destroy',
        id: '1'
      )
    end
  end
