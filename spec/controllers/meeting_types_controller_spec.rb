  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested meeting_type" do
        meeting_type = MeetingType.create! valid_attributes
        put :update, params: {id: meeting_type.to_param, meeting_type: new_attributes}, session: valid_session
        meeting_type.reload
      ...
      it "redirects to the meeting_type" do
        meeting_type = MeetingType.create! valid_attributes
        put :update, params: {id: meeting_type.to_param, meeting_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        meeting_type = MeetingType.create! valid_attributes
        put :update, params: {id: meeting_type.to_param, meeting_type: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
