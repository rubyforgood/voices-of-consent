...
RSpec.describe BoxRequestAbuseTypesController, type: :controller do
  ...
  # BoxRequestAbuseTypesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "returns a success response" do
      BoxRequestAbuseType.create! valid_attributes
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested box_request_abuse_type" do
        box_request_abuse_type = BoxRequestAbuseType.create! valid_attributes
        put :update, params: {id: box_request_abuse_type.to_param, box_request_abuse_type: new_attributes}, session: valid_session
        box_request_abuse_type.reload
        skip("Add assertions for updated state")
      end

      it "redirects to the box_request_abuse_type" do
        box_request_abuse_type = BoxRequestAbuseType.create! valid_attributes
        put :update, params: {id: box_request_abuse_type.to_param, box_request_abuse_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        box_request_abuse_type = BoxRequestAbuseType.create! valid_attributes
        put :update, params: {id: box_request_abuse_type.to_param, box_request_abuse_type: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
