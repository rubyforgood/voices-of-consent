...
RSpec.describe InventoryTalliesController, type: :controller do
  ...
  # InventoryTalliesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "returns a success response" do
      InventoryTally.create! valid_attributes
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested inventory_tally" do
        inventory_tally = InventoryTally.create! valid_attributes
        put :update, params: {id: inventory_tally.to_param, inventory_tally: new_attributes}, session: valid_session
      ...
      it "redirects to the inventory_tally" do
        inventory_tally = InventoryTally.create! valid_attributes
        put :update, params: {id: inventory_tally.to_param, inventory_tally: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        inventory_tally = InventoryTally.create! valid_attributes
        put :update, params: {id: inventory_tally.to_param, inventory_tally: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
