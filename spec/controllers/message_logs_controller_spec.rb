  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested message_log" do
        message_log = MessageLog.create! valid_attributes
        put :update, params: {id: message_log.to_param, message_log: new_attributes}, session: valid_session
        message_log.reload
      ...
      it "redirects to the message_log" do
        message_log = MessageLog.create! valid_attributes
        put :update, params: {id: message_log.to_param, message_log: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        message_log = MessageLog.create! valid_attributes
        put :update, params: {id: message_log.to_param, message_log: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
