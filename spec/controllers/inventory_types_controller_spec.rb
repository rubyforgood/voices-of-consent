  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested inventory_type" do
        inventory_type = InventoryType.create! valid_attributes
        put :update, params: {id: inventory_type.to_param, inventory_type: new_attributes}, session: valid_session
      ...
      it "redirects to the inventory_type" do
        inventory_type = InventoryType.create! valid_attributes
        put :update, params: {id: inventory_type.to_param, inventory_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        inventory_type = InventoryType.create! valid_attributes
        put :update, params: {id: inventory_type.to_param, inventory_type: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
