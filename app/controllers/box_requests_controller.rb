class BoxRequestsController < ApplicationController
  before_action :set_box_request, only: [:show, :edit, :update, :destroy]
  ...
  private
    ...
    def box_request_params
      params.require(:box_request).permit(:summary, :question_re_current_situation, :question_re_affect, :question_re_referral_source, :question_re_if_not_self_completed)
    end
end
