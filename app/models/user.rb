...
class User < ApplicationRecord
  ...
  has_many :box_items_as_creator,
           class_name: 'BoxItem',
           foreign_key: :created_by_id,
           inverse_of: :created_by,
           dependent: :restrict_with_error
  has_many :box_items_as_researcher,
           class_name: 'BoxItem',
           foreign_key: :created_by_id,
           inverse_of: :created_by,
           dependent: :restrict_with_error
  has_many :box_items_as_updater,
           class_name: 'BoxItem',
           foreign_key: :updated_by_id,
           inverse_of: :updated_by,
           dependent: :restrict_with_error
  has_many :box_requests_as_reviewer,
           class_name: 'BoxRequest',
           foreign_key: :reviewed_by_id,
           inverse_of: :reviewed_by,
           dependent: :restrict_with_error
  has_many :boxes_as_designer,
           class_name: 'Box',
           foreign_key: :designed_by_id,
           inverse_of: :designed_by,
           dependent: :restrict_with_error
  has_many :boxes_as_design_reviewer,
           class_name: 'Box',
           foreign_key: :design_reviewed_by_id,
           inverse_of: :design_reviewed_by,
           dependent: :restrict_with_error
  has_many :boxes_as_researcher,
           class_name: 'Box',
           foreign_key: :researched_by_id,
           inverse_of: :researched_by,
           dependent: :restrict_with_error
  has_many :boxes_as_assembler,
           class_name: 'Box',
           foreign_key: :assembled_by_id,
           inverse_of: :assembled_by,
           dependent: :restrict_with_error
  has_many :boxes_as_shipper,
           class_name: 'Box',
           foreign_key: :shipped_by_id,
           inverse_of: :shipped_by,
           dependent: :restrict_with_error
  has_many :boxes_as_followupper,
           class_name: 'Box',
           foreign_key: :followed_up_by_id,
           inverse_of: :followed_up_by,
           dependent: :restrict_with_error
  has_many :message_logs_sent,
  ...
  scope :permission,
        lambda { |permission_name|
          joins(:user_permissions).where(
            'user_permissions.permission ILIKE ?',
            "%#{permission_name}%"
          )
        }
  ...
  def is_admin?
    UserPermission.where(user_id: id, permission: 'manage users').present?
  end
end
